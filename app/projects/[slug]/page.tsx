      ...
      ? {
          video: project.videos.map((url) => {
            try {
              ...
              return { "@type": "VideoObject", name: `${project.title} video`, contentUrl: url };
            }
          }),
        }
      : {}),
    ...
    <main id="main">
      ...
      <header className="case-hero">
        <div className="container">
          <p className="eyebrow">{project.type || "Case study"}</p>
          <h1>{project.title}</h1>
          <p className="case-summary">{project.summary}</p>
          <dl className="case-facts">
            <div>
              <dt>Role</dt>
              <dd>{project.role || "Full Stack Developer"}</dd>
            </div>
            <div>
              <dt>Context</dt>
              <dd>
        ...
        {project.coverImage ? (
          <div className="case-cover">
            <Image
              ...
              alt={project.coverImageAlt || `${project.title} interface`}
              fill
              priority
              sizes="100vw"
            />
