      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div className="flex justify-center pt-4">
          <button 
            ...
            className="bg-[#64ffda] hover:bg-[#64ffda]/90 text-[#111A28] font-semibold px-8 py-2.5 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 text-sm min-w-[140px] justify-center"
          >
            {status === "loading" ? (
              <>
