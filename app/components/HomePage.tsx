...
export default function HomePage({ projectsSlot, blogsSlot }: { projectsSlot?: React.ReactNode; blogsSlot?: React.ReactNode }) {
  ...
  const skillsData = {
    Web: [
      ...
      { title: "Tailwind", img: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg", level: "Advanced" },
      ...
      <div className="bg-[#111A28] text-white">
        <div id="home" className="relative overflow-hidden">
          <div className="grid md:grid-cols-[38.2%_61.8%] h-[85vh] items-center">
            ...
            <div className="relative hidden md:flex items-center justify-center">
              ...
              <div className="relative w-80 h-80">
                ...
                <div className="absolute top-[23.6%] right-[23.6%] group">
                  <div className="relative">
                    <div className="w-16 h-16 bg-[#64ffda]/10 rounded-full flex items-center justify-center border border-[#64ffda]/30 group-hover:bg-[#64ffda]/20 transition-all duration-300">
                      <a href="https://github.com/raihanmiraj" target="_blank" rel="noreferrer" className="text-[#64ffda] hover:text-white transition-colors">
                ...
                <div className="absolute bottom-[23.6%] right-[38.2%] group">
                  <div className="relative">
                    <div className="w-16 h-16 bg-[#64ffda]/10 rounded-full flex items-center justify-center border border-[#64ffda]/30 group-hover:bg-[#64ffda]/20 transition-all duration-300">
                      <a href="https://www.linkedin.com/in/raihan-miraj" target="_blank" rel="noreferrer" className="text-[#64ffda] hover:text-white transition-colors">
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute top-[38.2%] left-[15%] group">
                  <div className="relative">
                    <div className="w-16 h-16 bg-[#64ffda]/10 rounded-full flex items-center justify-center border border-[#64ffda]/30 group-hover:bg-[#64ffda]/20 transition-all duration-300">
                      <a href="https://youtube.com/@raihanmiraj" target="_blank" rel="noreferrer" className="text-[#64ffda] hover:text-white transition-colors">
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Mobile Social Icons */}
            <div className="md:hidden flex justify-center gap-6  mt-0 md:mt-8 px-5">
              <a href="https://github.com/raihanmiraj" target="_blank" rel="noreferrer" className="w-12 h-12 bg-[#64ffda]/10 rounded-full flex items-center justify-center border border-[#64ffda]/30 text-[#64ffda] hover:text-white hover:bg-[#64ffda]/20 transition-all duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/raihan-miraj" target="_blank" rel="noreferrer" className="w-12 h-12 bg-[#64ffda]/10 rounded-full flex items-center justify-center border border-[#64ffda]/30 text-[#64ffda] hover:text-white hover:bg-[#64ffda]/20 transition-all duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </a>
              <a href="https://youtube.com/@raihanmiraj" target="_blank" rel="noreferrer" className="w-12 h-12 bg-[#64ffda]/10 rounded-full flex items-center justify-center border border-[#64ffda]/30 text-[#64ffda] hover:text-white hover:bg-[#64ffda]/20 transition-all duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
        ...
        <section id="about" className="md:h-screen flex items-center px-5 bg-[#0a1628]">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <div className=" grid lg:grid-cols-[61.8%_38.2%] gap-12 items-center md:h-[calc(90vh-150px)]">
              ...
              <div className="order-2 md:order-1  space-y-6 flex flex-col justify-center">
                <div className="relative">
              ...
              <div className="order-1 md:order-2 relative flex justify-center items-center h-full order-1 lg:order-2 mb-6 lg:mb-0">
              ...
              <div className="flex bg-[#111A28] rounded-lg p-1">
                {skillCategories.map((category) => (
                  <button
                    ...
                    className={`px-6 py-2 rounded-md transition-colors cursor-pointer ${activeSkillCategory === category
              ...
              <div className="space-y-3 md:space-y-4 order-1 lg:order-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-white text-sm font-medium">rsnmiraj@gmail.com</p>
                      </div>
                    </div>
                ...
                <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/30">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <a href="https://github.com/raihanmiraj" target="_blank" rel="noreferrer" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-700/40 transition-colors text-sm group">
                    ...
                    <a href="https://www.linkedin.com/in/raihan-miraj" target="_blank" rel="noreferrer" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-700/40 transition-colors text-sm group">
                      <div className="w-6 h-6 bg-[#64ffda]/10 rounded-md flex items-center justify-center group-hover:bg-[#64ffda]/20">
                        <svg className="w-3 h-3 text-[#64ffda]" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                        </svg>
                    ...
                    <a href="https://youtube.com/@raihanmiraj" target="_blank" rel="noreferrer" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-700/40 transition-colors text-sm group">
                      <div className="w-6 h-6 bg-[#64ffda]/10 rounded-md flex items-center justify-center group-hover:bg-[#64ffda]/20">
                        <svg className="w-3 h-3 text-[#64ffda]" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                        </svg>
                    ...
                    <a href="mailto:rsnmiraj@gmail.com" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-700/40 transition-colors text-sm group">
                      <div className="w-6 h-6 bg-[#64ffda]/10 rounded-md flex items-center justify-center group-hover:bg-[#64ffda]/20">
        ...
        <footer className="bg-[#0a1628] py-8 px-5 border-t border-gray-800">
          <div className="max-w-6xl mx-auto text-center">
            <div className="flex justify-center space-x-6 mb-6">
              <a href="https://github.com/raihanmiraj" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#64ffda] transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/raihan-miraj" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#64ffda] transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </a>
              <a href="https://youtube.com/@raihanmiraj" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#64ffda] transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
